 ...
 * @author MSI
 */
public class abonnementlistform extends SideMenuBaseForm {
     Form current;

    public abonnementlistform(Resources res) {
        super(BoxLayout.y());
        ...
        setTitle("Liste des abonnement");

        ArrayList<abonnement> list = abonnementS.getInstance().getAllCaracs();
        ...
        for (abonnement ab : list) {
            ...
            fourLinesIcon.setTextLine1("Abonnement de : " + ab.getAb_nom()+ "\n");
            fourLinesIcon.setTextLine2("prix : " + toString(ab.getAb_prix())+ "\n");
            fourLinesIcon.setTextLine3("type : " + ab.getAb_type()+ "\n");
